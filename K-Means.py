...
def hitung():
    ...
    with open('dataset.csv') as f:
        ...
        if tempc1valueclusterx and tempc1valueclustery and tempc2valueclusterx and tempc2valueclustery:
            c1=(float(sum(tempc1valueclusterx)/float(len(tempc1valueclusterx))), float(sum(tempc1valueclustery)/float(len(tempc1valueclustery))))
            c2=(float(sum(tempc2valueclusterx)/len(tempc2valueclusterx)), float(sum(tempc2valueclustery)/len(tempc2valueclustery)))
